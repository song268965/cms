...
Class GlobalFsoCls
        Private M_RefreshTemplateID,M_RefreshTempFileContent,M_RefreshCurrTid,M_RefreshCurrOtid
		...
		'初始化内容页相关信息
		Public Sub SetContentInfo(S_ChannelID,S_RefreshFolderID,S_RefreshOtid,S_RefreshInfoID,S_ItemTitle)
		   	RefreshType    = "Content"
			ChannelID      = S_ChannelID
			RefreshFolderID= S_RefreshFolderID
			RefreshCurrOtid= S_RefreshOtid
		...
		'====================刷新的当前附栏目ID================
		Public Property Let RefreshCurrOtid(ByVal strVar) 
		M_RefreshCurrOtid = strVar 
		End Property 
		
		Public Property Get RefreshCurrOtid
		RefreshCurrOtid= M_RefreshCurrOtid
		End Property 
		'================================================
