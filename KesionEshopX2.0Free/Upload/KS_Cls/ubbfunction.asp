...
Public Function Ubbcode(ByVal strcontent,n)
	strcontent=ReplaceVideo(strcontent)
...
'替换视频标签
Function ReplaceVideo(c)
        dim re:Set re=new RegExp
		re.pattern="\[media=(flv|mp4|f4v),*([0-9]*),*([0-9]*),*([0-1]*)\]([^\[]*)\[\/media\]"
		dim nn:nn=0
	    do while re.Test(c) 
		  dim tstr:tstr="<div style='text-align:center'><div id=""myvideo" & nn & """></div></div>" &vbcrlf
			tstr=tstr & "<script type=""text/javascript"" src=""" & KS.GetDomain & "ks_inc/ckplayer/ckplayer.js"" charset=""utf-8""></script>" 
			tstr=tstr & "<script type=""text/javascript"">" 
			tstr=tstr & "	var flashvars={f:'$5',c:0,s:0,b:1,p:$4};" 
			tstr=tstr & "	var params={bgcolor:'#FFF',allowFullScreen:true,allowScriptAccess:'always'};" 
			tstr=tstr & "	CKobject.embedSWF('" & KS.GetDomain & "ks_inc/ckplayer/ckplayer.swf','myvideo" & nn & "','ckplayer_myvideo" & nn & "','$2','$3',flashvars,params);" 
			tstr=tstr & "	var video=['$5->video/$1'];"
			tstr=tstr & "	var support=['iPad','iPhone','ios','android+false','msie10+false'];"
			If Fcls.CallFrom3g="true" Then
			tstr=tstr & "	CKobject.embedHTML5('myvideo" & nn & "','ckplayer_a1',""100%"",""300"",video,flashvars,support);" 
			Else
			tstr=tstr & "	CKobject.embedHTML5('myvideo" & nn & "','ckplayer_a1',$2,$3,video,flashvars,support);" 
			End If
			tstr=tstr & "</script>"
		 c= re.replace(c,tstr)
		 nn=nn+1
       loop
		...
		if re.Test(c) then c= re.replace(c,"<div><object classid=""clsid:CFCDAA03-8BE4-11cf-B84B-0020AFBBCCFA"" width=""$2"" height=""$3""><param name=""autostart"" value=""$4""/><param name=""src"" value=""$5""/><param name=""controls"" value=""imagewindow""/><param name=""console"" value=""mediaid""/><embed src=""$5"" type=""audio/x-pn-realaudio-plugin"" controls=""IMAGEWINDOW"" console=""mediaid"" width=""$2"" height=""$3""></embed></object><br/><object classid=""clsid:CFCDAA03-8BE4-11CF-B84B-0020AFBBCCFA"" width=""$2"" height=""32""><param name=""src"" value=""$5"" /><param name=""controls"" value=""controlpanel"" /><param name=""console"" value=""mediaid"" /><embed src=""$5"" type=""audio/x-pn-realaudio-plugin"" controls=""ControlPanel""  console=""mediaid"" width=""$2"" height=""32""></embed></object></div>")
	
		re.pattern="\[media=(wma),*([0-9]*),*([0-9]*),*([0-1]*)\]([^\[]*)\[\/media\]"
		if re.Test(c) then c= re.replace(c, "<object classid=""clsid:6BF52A52-394A-11d3-B153-00C04F79FAA6"" width=""$2"" height=""64""><param name=""autostart"" value=""$4"" /><param name=""url"" value=""$5"" /><embed src=""$5"" autostart=""$4"" type=""audio/x-ms-wma"" width=""$2"" height=""64""></embed></object>")
	
		re.pattern="\[media=(mp3),*([0-9]*),*([0-9]*),*([0-1]*)\]([^\[]*)\[\/media\]"
		if re.Test(c) then c= re.replace(c,"<object classid=""clsid:6BF52A52-394A-11d3-B153-00C04F79FAA6"" width=""$2"" height=""64""><param name=""autostart"" value=""$4"" /><param name=""url"" value=""$5"" /><embed src=""$5"" autostart=""$4"" type=""application/x-mplayer2"" width=""$2"" height=""64""></embed></object>")
	
		re.pattern="\[media=(wmv),*([0-9]*),*([0-9]*),*([0-1]*)\]([^\[]*)\[\/media\]"
		if re.Test(c) then c= re.replace(c,"<object classid=""clsid:6BF52A52-394A-11d3-B153-00C04F79FAA6"" width=""$2"" height=""$3""><param name=""autostart"" value=""$4"" /><param name=""url"" value=""$5"" /><embed src=""$5"" autostart=""$4"" type=""video/x-ms-wmv"" width=""$2"" height=""$3""></embed></object>")
	
		re.pattern="\[media=(swf),*([0-9]*),*([0-9]*),*([0-1]*)\]([^\[]*)\[\/media\]"
		if re.Test(c) then c= re.replace(c,"<object classid=""clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"" width=""$2"" height=""$3""><param name=""autostart"" value=""$4"" /><param name=""src"" value=""$5"" /><embed controller=""true"" width=""$2"" height=""$3"" src=""$5"" autostart=""1""></embed></object>")
