...
'================================图片模型开始================================
		   ...
		   case "getpicnums" echo GetNodeText("picnum")
		   case "getpictureintro" echo KS.ReplaceInnerLink(GetNodeText("picturecontent"))
		   case "getpictureurl"   echo KS.GetItemURL(ModelID,GetNodeText("tid"),ItemID,GetNodeText("fname"),GetNodeText("adddate"))
		   ...
		   case "getpicturevote" echo "<iframe src='about:blank' name='voteframe' style='display:none'></iframe><a target=""voteframe"" href=""" & DomainStr & "Item/Vote.asp?m=" & ModelID & "&ID=" & ItemID & """>投它一票</a>"
'================================图片模型结束================================
%>