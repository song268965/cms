...
function setvalue(obj) {
 try{
  	 top.frames['MainFrame'].frames[0].document.getElementById(varname).style.backgroundColor = setv;
	 top.frames['MainFrame'].frames[0].document.getElementById(varnamev).value = setv;
	if (setv==''){
	 top.frames['MainFrame'].frames[0].document.getElementById(varname).src='../images/RectNoColor.gif';
	}
	 top.frames['MainFrame'].frames[0].box.close();

 }catch(e){
	 top.frames['MainFrame'].document.getElementById(varname).style.backgroundColor = setv;
	 top.frames['MainFrame'].document.getElementById(varnamev).value = setv;
	if (setv==''){
	 top.frames['MainFrame'].document.getElementById(varname).src='images/RectNoColor.gif';
	}
	 top.frames['MainFrame'].box.close();
 }
}
...
<div id="h"><em id="p"></em><em id="pv"></em><em class="trans"title="取消颜色" onMouseOver="v('')" style="background-image:url('transcolor.gif')"></em></div>
<div id="colors"></div>
<script type="text/javascript"> 
showcolors();
