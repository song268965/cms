...
Class User_Recharge
		...
		Response.Write " <li class='puton'><a href=""user_recharge.asp"">充值卡充值</a></li>"
	   ...
	   <script type="text/javascript">
		...
		<FORM name=myform action="User_ReCharge.asp" method="post">
		  <table class=border cellSpacing=1 cellPadding=2 width="100%" align=center border=0>
			<tr class="title">
			  <td colSpan=2  height=22>&nbsp;充值卡充值</td>
			</tr>
			<tr class=tdbg>
		  ...
		  %>&nbsp;</td>
			...
			<tr class=tdbg>
			  ...
			  <td align=left height=40><Input id=Action type=hidden value="SaveExchangeEdays" name="Action"> 
