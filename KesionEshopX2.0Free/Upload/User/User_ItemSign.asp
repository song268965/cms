...
Class User_ItemSign
       ...
       Public Sub loadMain()
		...
		<div class="tabs">	
			<ul>
				<li class="puton"><a href="User_ItemSign.asp">文档签收</a></li>
			</ul>
		</div>
		<%
		dim fieldstr
  ...
  Sub ShowContent()
     Dim I,url
     Do While Not rs.eof 
	 Url=KS.GetItemUrl(1,rs("tid"),rs("id"),rs("fname"),rs("adddate"))
	%>
    <tr class=tdbg >
