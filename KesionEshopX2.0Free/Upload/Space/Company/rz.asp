		...
		Public Sub Kesion()
		   If KS.C_S(13,21) = "0" Then KS.Die "<script>alert('对不起，本频道未开启！');location.href='" & KS.Setting(3) & "';</script>"
			...
			End If
			 ...
			 Dim TpDir:TpDir=KS.SSetting(66)
			 If KS.IsNUL(TpDir) Then TpDir=KS.Setting(3) & KS.Setting(90) & "空间模板/企业通用/rz.html"
			...
			Do While Not RSC.Eof
			  ...
			  str=str & "<tr><th rowspan=""6"" align=""center"" valign=""middle""><div class=""yzimg""><a href='" & rsc("photourl") & "' target='_blank'><img src=""" & rsc("photourl") & """ width=""200px"" height=""130px"" /></a></div></th><td>" & vbcrlf
