...
Class CompanyList
		...
		Public Sub Kesion()
				   ...
				   Dim TpDir:TpDir=KS.SSetting(59)
				   If KS.IsNUL(TpDir) Then TpDir=KS.Setting(3) & KS.Setting(90) & "空间模板/企业通用/company_list.html"
		...
		Sub GetCompanyList()
		 ...
		 IF RS.Eof And RS.Bof Then
		  ...
		  Else
			...
			c_str =c_str & "<div style='text-align:center'>" &  KS.ShowPage(totalPut, MaxPerPage, "", CurrentPage,false,false) & "</div>"
        ...
        c_str=c_str & "<td width=""85"" align=""center"">积分排名</td>"
		 ...
		 Do While Not RS.Eof
		 logo=trim(rs("logo"))
		 if logo="" or isnull(rs("logo")) then logo="../../images/logo.png"
		 dim groupid:groupid=LFCls.GetSingleFieldValue("select top 1 groupid from ks_user where username='" & rs(2) & "'")
