	 ...
	 Sub showphoto(rs)
		 ...
		 Do While Not RS.Eof 
		  ...
		  str=str & "<li>" &vbcrlf
			...
			End If
			str=str &"<div class=""albumbg""><a href=""" & url &""" target=""_blank""><img style=""margin-left:-4px;margin-top:5px"" src=""" &RS("photourl") &""" width=""120"" height=""90"" border=0></a></div><B><a href=""" & Url &""" class=""xcname"">" &RS("xcname") &"</a></B> (" & RS("xps") & ")<font color=red>[" & GetStatusStr(RS("flag")) &"]</font>" & vbcrlf
			 str=str &"</li>"
			 RS.movenext
			I = I + 1
