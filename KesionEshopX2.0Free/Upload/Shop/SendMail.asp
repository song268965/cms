...
Dim ID,RS,ArticleUrl,WebName,WebUrl
...
IF RS.EOF And RS.BoF Then
 ...
 Set KS=Nothing
    ...
    Response.End
End if
If ArticleUrl="" Then ArticleUrl=KS.GetItemUrl(ChannelID,RS("Tid"),ID,RS("Fname"),RS("AddDate"))
...
Subject="您好" & KS.S("FrName") & ",您的朋友"&KS.S("MyName")&"从" & KS.S("SiteName") & "给您发来的一件商品信息资料"
    ...
    MailBody=MailBody &Content & "<br>以下是介绍<br>" & RS("ProIntro") 
    ...
    <td><table width="60%" border="0" align="center" cellpadding="0" cellspacing="1">
      ...
      <tr bgcolor="#FFFFFF">
        <td height="56" colspan="2"><br />
          您好!<br />
          我在<a href="<%=WebUrl%>" target="_blank">[<%=WebName%>]</a>上看到一件名称为<font color="#FF0000"><%=RS("Title")%></font>的商品，希望能对您有所帮助。<br />
