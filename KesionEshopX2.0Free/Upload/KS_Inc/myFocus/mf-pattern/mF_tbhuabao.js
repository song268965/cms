myFocus.pattern.extend({//*********************tbhuabao******************
	'mF_tbhuabao':function(settings,$){
		...
		$dotList.each(function(){this.innerHTML='<a href="javascript:;">&bull;</a>'});//灏忕偣
		...
		$picUl.find('li').each(function(){this.style.cssText='width:'+w+'px;height:'+h+'px;'});//婊戝姩锲哄畾鍏跺ぇ灏?
...
myFocus.config.extend({'mF_tbhuabao':{seamless:true}});//鏀寔镞犵绅璁剧疆