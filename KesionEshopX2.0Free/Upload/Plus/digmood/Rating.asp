   ...
   dim backurl:backurl=""
    If KS.C_S(Channelid,7)=1 or KS.C_S(ChannelID,7)=2 Then
				     ...
				     Set KSRObj.Node=DocXml.DocumentElement.SelectSingleNode("row")
					  ...
					  backurl=KS.GetItemURL(ChannelID,KSRObj.Node.SelectSingleNode("@tid").text,KSRObj.Node.SelectSingleNode("@id").text,KSRObj.Node.SelectSingleNode("@fname").text,KSRObj.Node.SelectSingleNode("@adddate").text)
