...
Dim WidthStr
If Request("Width")<>"" Then WidthStr=" style='width:" & Request("Width") &"px'"
%>
...
document.getElementById('City').options[0] = new Option('请选择市','');
document.getElementById('County').length = 0;
document.getElementById('County').options[0] = new Option('请选择县','');
...
{
<%If flag="getid" then%>
 if (subcity[i][0] == selectValue){document.getElementById('County').options[document.getElementById('County').length] = new Option(subcity[i][1], subcity[i][2]);}
<%else%>
...
%>
document.write ("<select name='Province' id='Province'<%=WidthStr%> class='select' onChange='changecity(this.value)'>");
...
document.write (" <select name='City'<%=WidthStr%> class='select' id='City' onChange='changeCounty(this.value)'>");
document.write ("<option value='' selected>请选择市..</option>");
document.write ("</select>")

document.write (" <select name='County'<%=WidthStr%> class='select' id='County'>");
document.write ("<option value='' selected>请选择县..</option>");
document.write ("</select>");
<%
CloseConn
%>
