...
Select Case KS.S("Action")
 ...
 Sub LoadMain
	 ...
	 SQLStr="Select top 1 ID,Tid,Fname,Title,IsSign,SignUser,SignDateLimit,SignDateEnd,adddate From " & KS.C_S(ChannelID,2) & " Where issign=1 and ID=" & InfoID
	 ...
	 If RS.Eof And RS.Bof Then 
	  ...
	  Exit Sub
	 End If
	 Url=KS.GetItemUrl(ChannelID,RS(1),rs(0),rs(2),rs("adddate"))
	 Title=RS(3)
