...
Sub RssList()
				...
				If IsOBject(ClassXml) Then
				  For Each Node In ClassXML.DocumentElement.SelectNodes("row")
					  ...
					  If tJ=1 Then
				        TreeStr = TreeStr  & "<li class='classname'>" & KS.GetClassNP(Node.SelectSingleNode("@id").text)& "<span class=""r""><a href=""rss.asp?classid=" & Node.SelectSingleNode("@id").text & "&channelid=" & Node.SelectSingleNode("@channelid").text & """ target=""_blank""><img src=""images/rss_xml.gif"" align=""absmiddle"" border=""0""></a></span></li>"
					  Else
						SpaceStr=""
						For k = 1 To TJ - 1
						  SpaceStr = SpaceStr & ""
       ...
       Function GetChannelNewInfo(ChannelID,sClassID,InfoNum,DescriptNum)
		...
		Else
			...
			For i = 0 to UBound(SQL,2)
				...
				GetChannelNewInfo = GetChannelNewInfo & "<link><![CDATA[" & KS.GetItemURL(ChannelID,SQL(2,I),SQL(0,I),SQL(3,I),SQL(4,I)) & "]]></link>"
