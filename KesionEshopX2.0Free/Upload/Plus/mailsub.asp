...
.boxright{text-align:left;width:300px;float:right;padding:20px; line-height:20px;}
.footerL li{ list-style-type:none;margin-bottom: 5px;}
.quxaio{background: #eee;border: 1px solid #ddd;padding: 7px 15px;border-radius: 3px;}
</style>
...
<div class="box">
	<div class="boxleft">
	  ...
	  <%Else%>
		  ...
		  <input type="submit" value="取消订阅" class="quxaio" onclick="if(document.myform.email.value==''){alert('请输入您的邮件!');return false;}document.getElementById('action').value='cancel';"/>
...
<div style="clear:both;color:#333333;padding:16px;" class="footerL">
 <%=KS.Setting(18)%>
</div>
<script>
