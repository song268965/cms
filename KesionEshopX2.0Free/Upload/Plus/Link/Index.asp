		...
		Function ReplaceListContent(Template)
		   '  on error resume next
			 ...
			 Dim ObjRS:Set ObjRS=Server.CreateObject("ADODB.Recordset")
			   ...
			   KeyWord = KS.DelSql(KS.S("KeyWord"))
		...
		Function GetDetailListStr(ObjRS, totalPut, MaxPerPage, CurrentPage, RClassID)
			  Dim AddDate, I, RecommendStr,LinkID
				  Do While Not ObjRS.EOF
					   ...
					   Else
						 GetDetailListStr = GetDetailListStr & replace(KS.CheckXSS(KS.HtmlCode(ObjRS("Description")&"")),chr(10),"<br/>")
					   End If
					 ...
					 Loop
					  GetDetailListStr = GetDetailListStr & KS.ShowPage(totalput, MaxPerPage, "", CurrentPage,false,false)
