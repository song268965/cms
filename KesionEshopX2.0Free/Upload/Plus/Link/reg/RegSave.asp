...
Class FriendLinkRegSave
		...
		SiteName = KS.LoseHtml(KS.S("SiteName"))
		WebMaster = KS.LoseHtml(KS.S("Webmaster"))
		...
		If SiteName <> "" Then
		 ...
		 End If
			  ...
			  LinkSql = "select  top 1 * from [KS_Link] Where 1=0"
			  ...
			  LinkRS("Description") = KS.LoseHtml(Descript)
			  LinkRS("AddDate") = Now
			  LinkRS("Verific") = 0
			  LinkRS.Update
			  LinkRS.Close
