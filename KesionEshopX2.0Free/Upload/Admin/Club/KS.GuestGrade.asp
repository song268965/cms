...
Class Admin_Ask_Class
		...
		<body>
		<div class='topdashed sort menu_top_fixed'><%IF TypeFlag=1 then response.write "论坛" else response.write "问吧"%>等级头衔设置</div>
		<div class="menu_top_fixed_height"></div>
		<div class="pageCont2"><form name="selform" id="selform" method="post" action="?">
		...
		<tr align="center">
			...
			<td class="splittd"><input class="textbox" type="text" size="5" name="Score<%=DataArry(0,i)%>" value="<%=DataArry(2,i)%>" /></td>
			  ...
			  <%if typeflag=1 then%>
			<td class="splittd">
			 <a href='../user/KS.User.asp?UserSearch=14&ClubGradeID=<%=DataArry(0,i)%>'>
		...
		%>
		<tr align="center">
			<td class="tablerow<%=lCount%> pt10" colspan="6">
