...
%>	   		
     <SCRIPT language=javascript>
	   ...
	   <%
		...
		Sub MainList()
         With KS 
		.echo "<form name='sform' action='?' method='post'><div class='tableTop'><table><tr><td><strong>按用户名搜索：</strong><input class='textbox' type='text' name='key'> <input class='button' type='submit' value='搜索'/></td></tr></table></div></form><div class='pageCont2 mt20'><table width='100%' border='0' cellpadding='0' cellspacing='0'>"
		...
		.echo "  </tr>"
		   ...
		   If KS.G("Key")<>"" Then Param=" where a.UserName='" & KS.S("Key") & "'"
			...
			If RS.EOF And RS.BOF Then
				  .echo "<tr><td  class='splittd' onMouseOver=""this.className='splittd'"" onMouseOut=""this.className='splittd'"" colspan=6 height='25' align='center'>没有微博数据!</td></tr>"
				 Else
		  ...
		  .echo " <td class='splittd weibodata' height='22' style='word-break:break-all;padding-top:10px;'><span style='cursor:default;'>"
		 ...
		 .echo "</table>"
		 .echo ("<table border='0' width='100%' cellspacing='0' cellpadding='0' align='center' class='mt10'>")
		...
		End Sub
		 ...
		 Sub Comment()
			 With KS  
			.echo "<form name='sform' action='?Action=comment' method='post'><div class='tableTop'><table><tr><td><strong>按用户名搜索：</strong><input class='textbox' type='text' name='key'> <input class='button' type='submit' value='搜索'/></td></tr></table></div></form><div class='pageCont2 mt20'><table width='100%' border='0' cellpadding='0' cellspacing='0'>"
			...
			.echo "  </tr>"
			   ...
			   If KS.G("Key")<>"" Then Param=" where UserName='" & KS.S("Key") & "'"
				...
				RS.Open SQLStr, conn, 1, 1
				If RS.EOF And RS.BOF Then
					  .echo "<tr><td  class='splittd' onMouseOver=""this.className='splittd'"" onMouseOut=""this.className='splittd'"" colspan=6 height='25' align='center'>没有评论数据!</td></tr>"
					 Else
	...
	End Sub
		 ...
		 Sub DelAllRecord()
		  ...
		  rs.close
		  set rs=nothing
		  	Conn.Execute("Delete From KS_UserLogR Where " & param)
