...
%>	   		
     <SCRIPT language=javascript>
		...
		function show(t,m,d)
		{
		 top.openWin('查看详情[<font color=red>'+t+'</font>]记录','KS.UserUseLog.asp?action=list&infoid='+d,false,750,440);
		}
	   ...
	   <%
		...
		.echo "<div class='tabTitle mt20'>查看会员使用记录</div>"
		...
		.echo "  </tr>"
		 ...
		 .echo ("<tr><td width='170' class='operatingBox'><div><b>选择：</b><a href='javascript:Select(0)'><font color=#999999>全选</font></a> - <a href='javascript:Select(1)'><font color=#999999>反选</font></a> - <a href='javascript:Select(2)'><font color=#999999>不选</font></a> </div>")
		 .echo ("</td>")
	     .echo ("<td class='operatingBox'><input type=""button"" value=""删除选中的记录"" onclick=""DelDiggList();"" class=""button""></td>")
