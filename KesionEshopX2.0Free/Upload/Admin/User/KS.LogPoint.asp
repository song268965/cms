...
For i=0 To Ubound(SQL,2)
  ...
  <%Next%>
  <tr class='list' onmouseout="this.className='list'" onmouseover="this.className='listmouseover'">    <td class="splittd" colspan='3' align='right'>本页合计：</td>    <td class="splittd" align='right'><%=InPoint%>点</td>    <td class="splittd" align='right'><%=OutPoint%>点</td>    <td class="splittd" colspan='6'>&nbsp;</td>  </tr> 
  ...
  %>
    <tr class='list' onmouseout="this.className='list'" onmouseover="this.className='listmouseover'">    <td class="splittd" colspan='3' align='right'>所有合计：</td>    <td class="splittd" align='right'><%=totalInPoint%>点</td>    <td class="splittd" align='right'><%=totalOutPoint%>点</td>    <td class="splittd" colspan='6'>&nbsp;</td>  </tr> 
  <%  
