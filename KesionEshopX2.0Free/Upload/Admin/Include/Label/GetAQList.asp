...
Class GetAQList
		...
		Dim ClassID, OpenType, RecommendTF, ShowClass,ShowUserName,Num, ZWLen, TitleLen, InfoSort, ColNumber, Province, NavType, Navi, DateRule, DateAlign, TitleCss, City,ShowStyle, PrintType,AjaxOut,LabelStyle,Page
       ...
       function InsertLabel(label)
		...
		function CheckForm()
		{
			...
			var RewardTF=false;
			if ($("#RewardTF").prop("checked")==true){RewardTF=true}
			var ZeroTF=false;
			if ($("#ZeroTF").prop("checked")==true){ZeroTF=true}
			var JJTF=false;
			if ($("#JJTF").prop("checked")==true){JJTF=true}
            var ShowClass=false;
			if ($("#ShowClass").prop("checked")==true){ShowClass=true}
            var ShowUserName=false;
			if ($("#ShowUserName").prop("checked")==true){ShowUserName=true}
            var ShowUserFace=false;
			if ($("#ShowUserFace").prop("checked")==true){ShowUserFace=true}
            var ShowReward=false;
			if ($("#ShowReward").prop("checked")==true){ShowReward=true}
		...
		.echo " <select id=""classid"" name=""classid"" class='textbox'>"
	...
	Set Rs = Nothing
		...
		.echo "                <select style=""width:70%;"" class='textbox' name=""InfoSort"">"
					...
					End If
					If InfoSort = "a.LastPostTime Desc" Then
