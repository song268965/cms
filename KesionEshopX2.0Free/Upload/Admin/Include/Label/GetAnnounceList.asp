...
Class GetAnnounceList
		...
		Dim AnnounceType, OWidth, OHeight, Width, Height, Speed, ShowStyle, OpenType, ListNumber, TitleLen, ShowAuthor, ContentLen, NavType, Navi, TitleCss,ChannelID,AjaxOut,Page
		...
		.echo "              <td width=""50%"" height=""24"">"
				...
				Else
				  ...
				  .echo ("<input class='button' class='button' type=""button"" onClick=""OpenThenSetValue('include/SelectPic.asp?CurrPath=" & CurrPath & "&ShowVirtualPath=true',550,290,window,document.myform.NaviPic);"" name=""Submit3"" value=""选择图片..."">")
				  .echo ("&nbsp;<span style=""cursor:pointer;color:green;"" onclick=""javascript:document.myform.NaviPic.value='';"" onmouseover=""this.style.color='red'"" onMouseOut=""this.style.color='green'"">清除</span>")
				  .echo ("</div>")
				End If
