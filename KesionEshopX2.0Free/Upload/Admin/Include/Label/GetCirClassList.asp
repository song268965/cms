...
Class GetCirClassList
		...
		Dim ButtonType,PriceType,TypeID,ShowGQType,Page
		...
		{  
		   ...
		   if (channelid!=0)  $("#ShowFieldArea").html($("#ShowFieldArea").html()+'<li onclick="InsertLabel(\'{@cmtnum}\')">评论数</li>')
		   if ($("#PrintType").val()==4){
		      $(parent.document).find('#ajaxmsg').toggle();
      ...
      function FieldInsertCode(fieldname,dbtype,dbname)
		...
		{  if (pos==null||tag==null) {top.$.dialog.alert('请先定位要插入的位置!');return false;}
			if (document.all){
				  pos.text=Val;
			}else{
				   var obj=$("#"+tag);
		...
		.echo "                <td width=""50%"" height=""20"">"
				...
				If LabelID = "" Or MenuBgType = "0" Then
				  ...
				  .echo " <img border=0 id=""ColorMenuBgShow"" src=""../../images/rect.gif"" style=""cursor:pointer;background-Color:" & MenuBg & ";"" onClick=""Getcolor('ColorMenuBgShow','../../../editor/ksplus/selectcolor.asp?ColorMenuBgShow|ColorMenuBg');"" title=""选取颜色"">"
				  .echo ("</div>")
				  ...
				  .echo ("<input  class='button' type=""button"" onClick=""OpenThenSetValue('include/SelectPic.asp?CurrPath=" & CurrPath & "&ShowVirtualPath=true',550,290,window,document.myform.PicMenuBg);"" name=""Submit3"" value=""选择图片..."">")
				...
				Else
				  ...
				  .echo " <img border=0 id=""ColorMenuBgShow1"" src=""../../images/rect.gif"" style=""cursor:pointer;background-Color:" & MenuBg & ";"" onClick=""Getcolor('ColorMenuBgShow1','../../../editor/ksplus/selectcolor.asp?ColorMenuBgShow1|ColorMenuBg');"" title=""选取颜色"">"
				  .echo ("</div>")
		...
		.echo "                <td><li onclick=""InsertLabel('{@autoid}')"">行号</li><li onclick=""InsertLabel('{@classname}')"">栏目名称</li><li onclick=""InsertLabel('{@classurl}')"">栏目URL</li> <li onclick=""InsertLabel('{@classimg}')"">栏目图片地址</li><li onclick=""InsertLabel('{@classintro}')"">栏目介绍(200字)</li><li onclick=""InsertLabel('{@tid}')"">栏目大ID</li><li onclick=""InsertLabel('{@classid}')"">栏目小ID</li><li onclick=""InsertLabel('{@parentid}')"">父栏目大ID</li><li onclick=""InsertLabel('{@parentclassid}')"">父栏目小ID</li><li onclick=""InsertLabel('{@parentclassurl}')"">父栏目URL</li></td>"
		.echo "                 </tr></table>"
		.echo "               </td>"
		.echo "            </tr>"
		.echo "            <tr class=tdbg>"
