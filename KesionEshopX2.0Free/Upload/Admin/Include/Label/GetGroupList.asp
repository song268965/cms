...
Dim ClassID,ShowStyle, OpenType, XCWidth, XCHeight, TitleCss, Num, TitleLen,ColNumber, ChannelID,PrintType,DivID,DivClass,UlID,UlClass,LiID,LiClass,recommend,morestr,ajaxOut,LabelStyle,Page
