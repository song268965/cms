...
Class GetLastSpecialList
		...
		Dim PerPageNumber, OpenType, IntroLen, TitleLen, NavType, Navi, SplitPic, DateRule, DateAlign, TitleCss, PhotoCss,PageStyle,ShowStyle,PicWidth,PicHeight,PrintType,AjaxOut,LabelStyle,RowHeight,Page
       ...
       function InsertLabel(label)
		...
		.echo "            </tr>"
		.echo "            <tr class='tdbg'>"
		.echo "              <td width=""50%"" height=""25"">" &ReturnDiyPageStyle(PageStyle)
