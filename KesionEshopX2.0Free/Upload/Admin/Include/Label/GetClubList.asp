...
Class GetClubList
		...
		Dim ClassID, OpenType,ShowClass,ShowUserName,Num, ZWLen, TitleLen, InfoSort, ColNumber, Province, NavType, Navi, DateRule, DateAlign, TitleCss, City,ShowStyle, PrintType,AjaxOut,LabelStyle,Page
       ...
       function InsertLabel(label)
		...
		function CheckForm()
		{
			...
			var ShowJh=false;
			if ($("#ShowJh").prop("checked")==true){ShowJh=true}
		...
		.echo "              <td width=""50%"" height=""24"">指定版面 "
