...
<!--#include file="ClassMenuParam.asp"-->
...
Response.Write "<script src='../../ks_inc/jquery.js'></script></head>" & vbCrLf
Response.Write "<body leftmargin='2' topmargin='0' marginwidth='0' marginheight='0'>" & vbCrLf
Response.Write "<div class='topdashed quickLink'>"
Response.Write "<b>管理导航:</b>&nbsp;&nbsp;<a href='ClassMenu.asp?Action=ShowConfig&ChannelID=" & ChannelID & "'>参数设置</a>"
Response.Write " | <a href='ClassMenu.asp?Action=ShowCreate&ChannelID=" & ChannelID & "'>菜单生成</a>"
Response.Write "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：参数设置▲代表鼠标悬停时效果，▼代表鼠标移出时效果。</div>"

Response.Write "<div class='pageCont2'>"

Response.Write "<table width='100%' border='0' align='center' cellpadding='0' cellspacing='0' class='boxStyle'>"

Response.Write "  <tr>"
Response.Write "    <td width='120' height='30'><strong>菜单演示：</strong>"
...
Sub ShowConfig()
 ...
 <%
    Response.Write "<form method='POST' action='ClassMenu.asp?action=SaveConfig' id='myform' name='myform'>"
    ...
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='MaxPerLine' type='text' class='textbox' id='MaxPerLine' value='" & MaxPerLine & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>生成文件名：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='JsFileName' type='text' class='textbox' id='JsFileName' value='" & JsFileName & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "  </tr>"
    ...
    Response.Write "    <td width='120'>"
    Response.Write "      <select name='RCM_Menu_1' id='RCM_Menu_1' class='textbox'>"
    ...
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_2' type='text' class='textbox' id='RCM_Menu_2' value='" & RCM_Menu_2 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>纵向偏移量：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_3' type='text' class='textbox' id='RCM_Menu_3' value='" & RCM_Menu_3 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "  </tr>"
    Response.Write "  <tr class='tdbg'> "
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项边距：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_4' type='text' class='textbox' id='RCM_Menu_4' value='" & RCM_Menu_4 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项间距：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_5' type='text' class='textbox' id='RCM_Menu_5' value='" & RCM_Menu_5 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项左边距：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_6' type='text' class='textbox' id='RCM_Menu_6' value='" & RCM_Menu_6 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "  </tr>"
    Response.Write "  <tr class='tdbg'> "
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项右边距：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_7' type='text' class='textbox' id='RCM_Menu_7' value='" & RCM_Menu_7 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单透明度：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_8' type='text' class='textbox' id='RCM_Menu_8' value='" & RCM_Menu_8 & "' size='10'  title='0-100 完全透明-完全不透明'>"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单其它特效：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_9' type='text' class='textbox' id='RCM_Menu_9' value='" & RCM_Menu_9 & "' size='10' maxlength='200'>"
    Response.Write "    </td>"
    Response.Write "  </tr>"
    Response.Write "  <tr class='tdbg'> "
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单弹出效果▲：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <select name='RCM_Menu_10' id='RCM_Menu_10' class='textbox'>"
    Response.Write "        <option value='-1' "
    ...
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单弹出效果▼：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <select name='RCM_Menu_12' id='RCM_Menu_12' class='textbox'>"
    Response.Write "        <option value='-1' "
    ...
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_13' type='text' class='textbox' id='RCM_Menu_13' value='" & RCM_Menu_13 & "' size='10'  title='速度值：10-100'>"
    Response.Write "    </td>"
    Response.Write "  </tr>"
    Response.Write "  <tr class='tdbg'> "
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单阴影效果：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <select name='RCM_Menu_14' id='RCM_Menu_14' class='textbox'>"
    Response.Write "        <option value='0' "
    ...
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_15' type='text' class='textbox' id='RCM_Menu_15' value='" & RCM_Menu_15 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单阴影颜色：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_16' type='text' class='textbox' id='RCM_Menu_16' value='" & RCM_Menu_16 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "  </tr>"
    Response.Write "  <tr class='tdbg'> "
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单背景颜色：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_17' type='text' class='textbox' id='RCM_Menu_17' value='" & RCM_Menu_17 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单背景图片：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_18' type='text' class='textbox' id='RCM_Menu_18' value='" & RCM_Menu_18 & "' size='10' maxlength='200' title='只有当菜单项背景颜色设为透明色：transparent 时才有效'>"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>背景图片平铺模式：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <select name='RCM_Menu_19' id='RCM_Menu_19' class='textbox'>"
    Response.Write "        <option value='0' "
    ...
    Response.Write "    <td width='120'>"
    Response.Write "      <select name='RCM_Menu_20' id='RCM_Menu_20' class='textbox'>"
    Response.Write "        <option value='0' "
    ...
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_21' type='text' class='textbox' id='RCM_Menu_21' value='" & RCM_Menu_21 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单边框颜色：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Menu_22' type='text' class='textbox' id='RCM_Menu_22' value='" & RCM_Menu_22 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "  </tr>"
...
'    response.write "    <td width='120'>"
'    response.write "      <input name='RCM_Item_2' type='text' class='textbox' id='RCM_Item_2' value='" & RCM_Item_2 & "' size='10' >"
'    response.write "    </td>"
'    response.write "    <td width='130' height='25'><strong>图片文件：</strong></td>"
'    response.write "    <td width='120'>"
'    response.write "      <input name='RCM_Item_3' type='text' class='textbox' id='RCM_Item_3' value='" & RCM_Item_3 & "' size='10' >"
'    response.write "    </td>"
'    response.write "  </tr>"
'    response.write "  <tr class='tdbg'> "
'    response.write "    <td width='130' height='25'><strong>鼠标指在菜单项时，图片文件：</strong></td>"
'    response.write "    <td width='120'>"
'    response.write "      <input name='RCM_Item_4' type='text' class='textbox' id='RCM_Item_4' value='" & RCM_Item_4 & "' size='10' >"
'    response.write "    </td>"
'    response.write "    <td width='130' height='25'><strong>图片宽度：</strong></td>"
'    response.write "    <td width='120'>"
'    response.write "      <input name='RCM_Item_5' type='text' class='textbox' id='RCM_Item_5' value='" & RCM_Item_5 & "' size='10' >"
'    response.write "    </td>"
'    response.write "    <td width='130' height='25'><strong>图片高度：</strong></td>"
'    response.write "    <td width='120'>"
'    response.write "      <input name='RCM_Item_6' type='text' class='textbox' id='RCM_Item_6' value='" & RCM_Item_6 & "' size='10' >"
'    response.write "    </td>"
'    response.write "  </tr>"
'    response.write "  <tr class='tdbg'> "
'    response.write "    <td width='130' height='25'><strong>图片边框：</strong></td>"
'    response.write "    <td width='120'>"
'    response.write "      <input name='RCM_Item_7' type='text' class='textbox' id='RCM_Item_7' value='" & RCM_Item_7 & "' size='10' >"
'    response.write "    </td>"
'    response.write "    <td width='130' height='25'><strong>链接地址：</strong></td>"
'    response.write "    <td width='120'>"
'    response.write "      <input name='RCM_Item_8' type='text' class='textbox' id='RCM_Item_8' value='" & RCM_Item_8 & "' size='10' >"
'    response.write "    </td>"
'    response.write "    <td width='130' height='25'><strong>链接目标：</strong></td>"
'    response.write "    <td width='120'>"
'    response.write "      <input name='RCM_Item_9' type='text' class='textbox' id='RCM_Item_9' value='" & RCM_Item_9 & "' size='10' >"
'    response.write "    </td>"
'    response.write "  </tr>"
'    response.write "  <tr class='tdbg'> "
'    response.write "    <td width='130' height='25'><strong>链接状态栏显示：</strong></td>"
'    response.write "    <td width='120'>"
'    response.write "      <input name='RCM_Item_10' type='text' class='textbox' id='RCM_Item_10' value='" & RCM_Item_10 & "' size='10' >"
'    response.write "    </td>"
'    response.write "    <td width='130' height='25'><strong>链接地址提示信息：</strong></td>"
'    response.write "    <td width='120'>"
'    response.write "      <input name='RCM_Item_11' type='text' class='textbox' id='RCM_Item_11' value='" & RCM_Item_11 & "' size='10' >"
'    response.write "    </td>"
...
'    response.write "  </tr>"
    ...
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_12' type='text' class='textbox' id='RCM_Item_12' value='" & RCM_Item_12 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项左图片▲：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_13' type='text' class='textbox' id='RCM_Item_13' value='" & RCM_Item_13 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>左图片宽度：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_14' type='text' class='textbox' id='RCM_Item_14' value='" & RCM_Item_14 & "' size='10'  title='0为图像原始宽度'>"
    Response.Write "    </td>"
    Response.Write "  </tr>"
    Response.Write "  <tr class='tdbg'> "
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>左图片高度：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_15' type='text' class='textbox' id='RCM_Item_15' value='" & RCM_Item_15 & "' size='10'  title='0为图像原始高度'>"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>左图片边框大小：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_16' type='text' class='textbox' id='RCM_Item_16' value='" & RCM_Item_16 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项右图片：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_17' type='text' class='textbox' id='RCM_Item_17' value='" & RCM_Item_17 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "  </tr>"
    Response.Write "  <tr class='tdbg'> "
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项右图片▲：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_18' type='text' class='textbox' id='RCM_Item_18' value='" & RCM_Item_18 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>右图片宽度：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_19' type='text' class='textbox' id='RCM_Item_19' value='" & RCM_Item_19 & "' size='10'  title='0为图像原始宽度'>"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>右图片高度：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_20' type='text' class='textbox' id='RCM_Item_20' value='" & RCM_Item_20 & "' size='10'  title='0为图像原始高度'>"
    Response.Write "    </td>"
    Response.Write "  </tr>"
    Response.Write "  <tr class='tdbg'> "
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>右图片边框大小：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_21' type='text' class='textbox' id='RCM_Item_21' value='" & RCM_Item_21 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>文字水平对齐方式：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <select name='RCM_Item_22' id='RCM_Item_22' class='textbox'>"
    Response.Write "        <option value='0' "
    ...
    Response.Write "    <td width='120'>"
    Response.Write "      <select name='RCM_Item_23' id='RCM_Item_23' class='textbox'>"
    Response.Write "        <option value='0' "
    ...
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_24' type='text' class='textbox' id='RCM_Item_24' value='" & RCM_Item_24 & "' size='10'  title='透明色：transparent'>"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>背景颜色是否显示：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <select name='RCM_Item_25' id='RCM_Item_25' class='textbox'>"
    Response.Write "        <option value='0' "
    ...
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项背景颜色▲：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_26' type='text' class='textbox' id='RCM_Item_26' value='" & RCM_Item_26 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "  </tr>"
    Response.Write "  <tr class='tdbg'> "
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>背景颜色是否显示▲：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <select name='RCM_Item_27' id='RCM_Item_27' class='textbox'>"
    Response.Write "        <option value='0' "
    ...
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_28' type='text' class='textbox' id='RCM_Item_28' value='" & RCM_Item_28 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项背景图片▲：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_29' type='text' class='textbox' id='RCM_Item_29' value='" & RCM_Item_29 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "  </tr>"
    Response.Write "  <tr class='tdbg'> "
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>背景图片平铺模式：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <select name='RCM_Item_30' id='RCM_Item_30' class='textbox'>"
    Response.Write "        <option value='0' "
    ...
    Response.Write "    <td width='120'>"
    Response.Write "      <select name='RCM_Item_32' id='RCM_Item_32' class='textbox'>"
    Response.Write "        <option value='0' "
    ...
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_33' type='text' class='textbox' id='RCM_Item_33' value='" & RCM_Item_33 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "  </tr>"
    Response.Write "  <tr class='tdbg'> "
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项边框颜色：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_34' type='text' class='textbox' id='RCM_Item_34' value='" & RCM_Item_34 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项边框颜色▲：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_35' type='text' class='textbox' id='RCM_Item_35' value='" & RCM_Item_35 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项文字颜色：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_36' type='text' class='textbox' id='RCM_Item_36' value='" & RCM_Item_36 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "  </tr>"
    Response.Write "  <tr class='tdbg'> "
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项文字颜色▲：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <input name='RCM_Item_37' type='text' class='textbox' id='RCM_Item_37' value='" & RCM_Item_37 & "' size='10' >"
    Response.Write "    </td>"
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项文字字体：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <select name='FontName_RCM_Item_38' id='FontName_RCM_Item_38' class='textbox'>"
    ...
    Response.Write "      </select>"
    Response.Write "      <select name = 'FontSize_RCM_Item_38' id='FontSize_RCM_Item_38' class='textbox'>"
    ...
    Response.Write "    <td width='130' height='25' class='clefttitle'><strong>菜单项文字字体▲：</strong></td>"
    Response.Write "    <td width='120'>"
    Response.Write "      <select name='FontName_RCM_Item_39' id='FontName_RCM_Item_39' class='textbox'>"
    Response.Write "        <option value='宋体' "
    ...
    Response.Write "        >Wingdings</option>"
    Response.Write "      </select>"
    Response.Write "      <select name = 'FontSize_RCM_Item_39' id='FontSize_RCM_Item_39' class='textbox'>"
    Response.Write "        <option value=""9pt"" "
...
Sub SaveConfig()
    ...
    Call KS.WriteTOFile(strInstallDir & KS.Setting(89) & "include/ClassMenuParam.asp", Param)
...
Sub ShowCreate_RootClass_Menu()
    ...
    Response.Write "<form name='myform' method='post' action='ClassMenu.asp'>"
...
Sub Create_RootClass_Menu()
	...
	Response.Write "<input name='s1' class='textbox' value='&lt;script language=&quot;javascript&quot; type=&quot;text/javascript&quot; src=&quot;" & strInstallDir & "ks_inc/stm31.js&quot;&gt;&lt;/script&gt;' size='80'>&nbsp;<input class=""button"" onClick=""jm_cc('s1')"" type=""button"" value=""复制到剪贴板"" name=""button"">"
    Response.Write "<p><b>第二步：将以下代码复制到在模板里要显示的地方。</b></p>"
	Response.Write "<input name='s2' class='textbox' value='&lt;script language=&quot;javascript&quot; type=&quot;text/javascript&quot; src=&quot;" & KS.Setting(3) & KS.Setting(93) & JsFileName & "&quot;&gt;&lt;/script&gt;' size='80'>&nbsp;<input class=""button"" onClick=""jm_cc('s2')"" type=""button"" value=""复制到剪贴板"" name=""button1"">"
    Response.Write "    </td>"
    Response.Write "  </tr>"
    Response.Write "</table>"
 %>
