...
Class RefreshIndex
		...
		Sub Kesion()
		  With Response
		  If Not KS.ReturnPowerResult(0, "ref20000") Then          '检查是否有发布站点首页的权限
		 ...
		 If Split(KS.Setting(5),".")(1)="asp" Then 
		   Head 
		   KS.Die ("<script>top.$.dialog.alert('KesionCMS系统提醒您：<br/>1、站点首页没有启用生成静态HTML功能<br/>2、请到系统设置->基本信息设置启用生成静态Html功能<br/>',function(){history.back()});</script>"):Exit Sub
		 End If
		...
		Sub Main()
			With Response	  
				...
				Else
		        .Write ("<body oncontextmenu=""return false;"" scroll=no bgcolor='transparent'  style=""background-color:#ffffff;padding-left:20px;padding-top:50px"">")
				End If
				If KS.G("RefreshFlag")<>"Info" Then
				.Write ("<div class='pageCont2 mt20'><div class='tabTitle'>发布网站首页</div>")
