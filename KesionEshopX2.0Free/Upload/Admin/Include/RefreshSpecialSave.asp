...
Class RefreshSpecialSave
		...
		Sub Main()
		 ...
		 Response.Write ("<body oncontextmenu=""return false;"">")
				Response.Write "<div class='pageCont2'><table id=""BarShowArea"" width=""400"" border=""0"" align=""center"" cellspacing=""1"" cellpadding=""1"" style='margin:0 auto 20px;'>"
				Response.Write "<tr> "
				...
				Response.Write "<table width=""100%"" border=""0"" align=""center"" cellspacing=""1"" cellpadding=""1""><tr> "
		 ...
		 Response.Write ("<table width=""100%"" height=""50%""  border=""0"" align=""center"" cellpadding=""0"" cellspacing=""0"">")
		 Response.Write (" <tr>")
