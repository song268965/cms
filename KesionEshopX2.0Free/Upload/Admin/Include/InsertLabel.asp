...
Dim RS:Set RS=Conn.Execute("Select ChannelID,BasicType,ChannelName,ItemName,ItemUnit,FieldBit,ModelEname From KS_Channel Where ChannelStatus=1 and channelid<>6  And ChannelID<>9 And ChannelID<>10 and BasicType<10 Order By ChannelID")
SQL=RS.GetRows(-1)
...
.icon{ height:24px; width:23px; display:inline-block; background:url(../Images/ico/123456.png) no-repeat; vertical-align:middle}
.icon.folder{background-position:-491px -142px;}
.icon.mainer{ background-position:-827px -119px;}

</style>
</head>
<body topmargin="0" leftmargin="0" style="padding-left:5px">
  ...
  <tr>
    <td valign="top"> 
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr ParentID=""> 
          <td> <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr  onmouseout="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'">
                <td><i class='icon mainer'></i></td>
                <td height="20">标签导航</td>
              </tr>
              <tr onClick="return(ShowLabelTree('TY'))" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'"> 
                <td width="24"><i class='icon folder'></i></td>
              ...
              <tr> 
                <td colspan="2"> 
				   <div id="TY" style="display:none">
					...
					<li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>Editor/KSPlus/LabelParam.asp?action=Tags',250,130);">显示热门Tags/最新Tags/搜索Tags</a></li>
					<li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>Editor/KSPlus/LabelParam.asp?action=limitbuy',300,130);" style='color:red'>显示限时限量抢购(新增)</a></li>
	   ...
	   <div onClick="return(ShowLabelTree('CommonJSLabel'))" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'">
               <i class='icon folder'></i><a href="#">常用脚本特效标签</a></div>
				 ...
				 <div id="CommonJSLabel" style="display:none">
					 ...
					 <li><a href="#" onClick="InsertLabel('{$JS_Time1}');" class="LabelItem">时间特效(样式:<script src="../../ks_inc/time/1.js"></script>)</a></li>
					 <li><a href="#" onClick="InsertLabel('{$JS_Time2}');" class="LabelItem">时间特效(样式:<script src="../../ks_inc/time/2.js"></script>)</a></li>
					 <li><a href="#" onClick="InsertLabel('{$JS_Time3}');" class="LabelItem">时间特效(样式:<script src="../../ks_inc/time/3.js"></script>)</a></li>
					 <li><a href="#" onClick="InsertLabel('{$JS_Time4}');" class="LabelItem">时间特效(样式:<span id="kstime"></span><script>setInterval("kstime.innerHTML=new Date().toLocaleString()+' 星期'+'日一二三四五六'.charAt (new Date().getDay());",1000);</script>)</a></li>
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr ParentID=""> 
          <td> <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr onClick="return(ShowLabelTree('SysFLabel'))" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'"> 
                <td width="24"><i class='icon folder'></i></td>
                      ...
                      <td height="20"> <table width="100%" border="0" cellpadding="0" cellspacing="0">
	                    ...
	                    do while Not FolderRS.Eof
                          ...
                          <tr ParentID="<% = FolderRS("ParentID") %>" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'"> 
                            <td> <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td width="3%"><i class='icon folder'></i></td>
         ...
         <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr ParentID=""> 
              <td> 
               ...
               <tr onClick="return(ShowLabelTree('ContentLabel'))" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'"> 
                <td width="24"><i class='icon folder'></i></td>
                ...
                <td colspan="2">
                    ...
                    <tr> 
					 ...
					 <%
					  ...
					  %>
					 	<div onClick="return(ShowLabelTree('Content<%=SQL(6,K)%>'))" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'">
					<i class='icon folder'></i><a href="#"><%=SQL(3,K)%>内容页标签(<%=sql(2,k)%>)</a>
				     </div>	
					 <%Select Case SQL(1,K)%>
					  <%case 1%>
					  <div  id="Content<%=SQL(6,K)%>" style="display:none">
						...
						<li><a href="#" onClick="InsertLabel('{$GetSpecialName}');" class="LabelItem">所属专题</a></li>
						...
						<li><a href="#" onClick="InsertLabel('{$GetArticlePageList}');">分页导航</a></li>
			...
			<div id="Content<%=SQL(6,K)%>" style="display:none">
				...
				<li><a href="#" onClick="InsertLabel('{$GetAddDate}');" class="LabelItem">添加日期(格式:2012年10月1日)</a></li>
				<li><a href="#" onClick="InsertLabel('{$GetModifyDate}');">修改时间(格式:2012年10月1日)</a></li>
				<li><a href="#" onClick="InsertLabel('{$GetBaiduPlayerList}');" class="LabelItem">百度播放列表</a></li>
				<li><a href="#" onClick="InsertLabel('{$GetQvodPlayerList}');" class="LabelItem">快播播放列表</a></li>
				...
				<li><a href="#" onClick="InsertLabel('{$GetMovieXunLeiDownList}');" class="LabelItem">迅雷下载列表</a></li>
				<li><a href="#" onClick="InsertLabel('{$GetMovieFlashGetDownList}');" class="LabelItem">快车下载列表</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetHits}');" class="LabelItem"><%=SQL(3,K)%>人气(总浏览数)</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetHitsByDay}');" class="LabelItem"><%=SQL(3,K)%>本日浏览数</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetHitsByWeek}');" class="LabelItem"><%=SQL(3,K)%>本周浏览数</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetHitsByMonth}');" class="LabelItem"><%=SQL(3,K)%>本月浏览数</a></li>
	  ...
	  <div onClick="return(ShowLabelTree('ChannelClassLabel'))" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'">
                <i class='icon folder'></i><a href="#">频道（栏目）专用标签</a>
	  </div>
				  <div id="ChannelClassLabel" style="display:none">  
					...
					<li><a href="#" onClick="InsertLabel('{$GetClassEName}');">显示当前栏目英文名称</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetClassDocNum}');">显示当前栏目文档数量</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetClassUrl}');" class="LabelItem">显示当前栏目链接地址</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetClassPicSrc}');" class="LabelItem">显示当前栏目图片Src</a></li>
					...
					<li><a href="#" onClick="InsertLabel('{$GetTopClassEName}');">显示一级栏目英文名称</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetTopClassUrl}');">显示一级栏目URL</a></li>
					========================<br/>
				    <li><a href="#" onClick="InsertLabel('{$GetOClassID}');">显示当前附栏目ID</a></li>
				    <li><a href="#" onClick="InsertLabel('{$GetOSmallClassID}');">显示当前附栏目ClassID</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetOClassName}');">显示当前附栏目名称</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetOClassEName}');">显示当前附栏目英文名称</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetOClassUrl}');" class="LabelItem">显示当前附栏目链接地址</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetOClassPicSrc}');" class="LabelItem">显示当前附栏目图片Src</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetOClassIntro}');" class="LabelItem">显示当前附栏目介绍</a></li>
				    <li><a href="#" onClick="InsertLabel('{$GetOParentID}');">显示附栏目的父ID</a></li>
				    <li><a href="#" onClick="InsertLabel('{$GetOParentClassID}');">显示附栏目的父ClassID</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetOParentUrl}');">显示附栏目的父链接地址</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetOParentClassName}');">显示附栏目的父栏目名称</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetOTopClassName}');">显示附栏目的一级栏目名称</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetOTopClassEName}');">显示附栏目的一级栏目英文名称</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetOTopClassUrl}');">显示附栏目的一级栏目URL</a></li>
				 </div>
               
	  
       <div onClick="return(ShowLabelTree('SearchLabel'))" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'">
                <i class='icon folder'></i><a href="#">搜索专用标签</a>
		</div>
	    ...
	    <div onClick="return(ShowLabelTree('AnnounceContent'))" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'"> 
               <i class='icon folder'></i><a href="#">公告内容页标签</a>
		</div>
		 ...
		 <div id="AnnounceContent" style="display:none">
	  	  ...
	  	  <div onClick="return(ShowLabelTree('LinkContent'))" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'">
                    <i class='icon folder'></i><a href="#">友情链接页标签</a>
		 </div>
	  	  ...
	  	  <div onClick="return(ShowLabelTree('Special'))" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'">
                    <i class='icon folder'></i><a href="#">专题页标签</a>
		 </div>
	  	  ...
	  	  <div onClick="return(ShowLabelTree('UserSystem'));" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'">
                    <i class='icon folder'></i><a href="#">会员系统专用标签</a>
		  </div>
		 ...
		 <div onClick="return(ShowLabelTree('AdwLabel'));" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'"> 
                <i class='icon folder'></i><a href="#">广告位通用标签</a></div>
	    ...
	    <div onClick="return(ShowLabelTree('VoteLabel'));" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'"> 
                <i class='icon folder'></i><a href="#">网站调查通用标签</a></div>
		 ...
		 <div onClick="return(ShowLabelTree('RssLabel'));" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'"> 
                <i class='icon folder'></i><a href="#">RSS标签</a>
		 </div>
	  ...
	  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr ParentID=""> 
          <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr onClick="return(ShowLabelTree('DIYFunctionLabel'))" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'"> 
                <td width="24"><i class='icon folder'></i></td>
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr ParentID=""> 
          <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr onClick="return(ShowLabelTree('FreeLabel'))" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'"> 
                <td width="24"><i class='icon folder'></i></td>
	   ...
	   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr ParentID=""> 
          <td> <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr onClick="return(ShowLabelTree('SysJS'))" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'"> 
                <td width="24"><i class='icon folder'></i></td>
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr ParentID=""> 
          <td> <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr onClick="return(ShowLabelTree('JSLabel'))" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'"> 
                <td width="24"><i class='icon folder'></i></td>
	                    ...
	                    do while Not FolderRS.Eof
                          ...
                          <tr ParentID="<% = FolderRS("ParentID") %>" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'"> 
                            <td> <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td width="3%"><i class='icon folder'></i></td>
                                  <td width="97%"><span ShowFlag="False" TypeID="<% = FolderRS("ID") %>" onClick="SelectFolder(this);return false;"><A href="#"> 
                                    <% = FolderRS("FolderName") %>
                                    </A></span></td>
                                </tr>
                              </table></td>
...
{
  top.frames["MainFrame"].LabelInsert(LabelContent);
  top.box.close();
}
function InsertFunctionLabel(Url,Width,Height)
{
 var val=(OpenWindow(Url,Width,Height,window));
  InsertLabel(val);
}
