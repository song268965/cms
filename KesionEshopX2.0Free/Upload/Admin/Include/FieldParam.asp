...
function submitdate(){
    ...
    top.frames["MainFrame"]["LabelShow"].InsertValue(dbname);
	top.box.close();
}
</script>
</head>
...
%>
	...
	<tr class="tdbg"><td><strong>截断显示：</strong><Input class="textbox" name='CatType' type='text' value='...' size="6">
...
%>
    ...
    <tr class="tdbg">
      <td><strong>输出格式：</strong>
        <input name='Datemb' type='text' id='Datemb' class="textbox" size='28' value="YYYY-MM-DD">
		<br>
