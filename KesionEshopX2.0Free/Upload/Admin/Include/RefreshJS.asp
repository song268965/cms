...
Class RefreshJS
		...
		If Not KS.ReturnPowerResult(0, "ref20002") Then                '发布系统JS的权限检查
			  Call KS.ReturnErr(1, "")
		End If
		...
		Response.Write "<div class='pageCont2 pt0'><table width=""100%"" style='margin-top:2px'  border=""0"" cellpadding=""0"" align=""center"" cellspacing=""1"">"
		Response.Write "  <tr>"		
		Response.Write "    <td height=""35"" colspan=""2"" class='tabTitle'>发布系统JS操作</td>"
		Response.Write "  </tr>"
		...
		Response.Write "    <tr>"
		Response.Write "      <td width='100' height='25' align='right' class='clefttitle'>按系统JS目录发布</td>"
		...
		Response.Write "              <select name=""TempFolderID"" size=12 multiple id=""TempFolderID"" style=""width:300px;height:146px;"">"
		...
		Response.Write "<div style=""height:30px;text-align:center"">KeSion CMS X" & KS.GetVersion &", Copyright (c) 2006-" & YEAR(NOW) &" <a href=http://www.kesion.com/ target=""_blank""><font color=#cc6600>KeSion.Com</font></a>. All Rights Reserved . </div></div>"
		Response.Write "</body>"
		Response.Write "</html>"
		End Sub
End Class
