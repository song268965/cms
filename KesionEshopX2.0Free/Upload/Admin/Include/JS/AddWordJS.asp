...
Class AddWordJS
		...
		Response.Write "                    <td width=""50%"" height=""28"">"
				 If JSID = "" Or CStr(NavType) = "0" Then
				  ...
				  Response.Write ("<input type=""button"" onClick=""OpenModalDialog('../SelectPic.asp?CurrPath=" & CurrPath & "&ShowVirtualPath=true',550,290,window,document.myform.NaviPic);"" name=""Submit3"" value=""选择图片..."">")
		...
		Response.Write "                    <td width=""50%"" height=""28"">"
				  ...
				  If JSID = "" Or CStr(MoreLinkType) = "0" Then
					...
					Response.Write ("<input type=""button"" onClick=""OpenModalDialog('../SelectPic.asp?CurrPath=" & CurrPath & "&ShowVirtualPath=true',550,290,window,document.myform.MoreLinkPic);"" name=""Submit3"" value=""选择图片..."">")
		...
		Response.Write "                      <input name=""SubmitPic"" onClick=""OpenModalDialog('../SelectPic.asp?CurrPath=" & CurrPath & "&ShowVirtualPath=true',550,290,window,document.myform.SplitPic);"" type=""button"" id=""SubmitPic"" value=""选择图片..."">"
