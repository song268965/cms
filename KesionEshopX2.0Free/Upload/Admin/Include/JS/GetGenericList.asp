...
Class GetGenericList
		...
		function CheckForm()
		{
			...
			if (ChannelID==5){
			 ...
			 var Discount=false;
			 if ($("#Discount").prop("checked")==true)  Discount= true;
		...
		.echo "                <select name=""NavType"" style=""width:70%;"" class='textbox' onchange=""SetNavStatus()"">"
		 ...
		 .echo "             <td width=""50%"" height=""24"">"
			   If JSID = "" Or CStr(NavType) = "0" Then
				  ...
				  .echo ("<input class='button' type=""button"" onClick=""OpenModalDialog('../SelectPic.asp?CurrPath=" & CurrPath & "&ShowVirtualPath=true',550,290,window,document.myform.NaviPic);"" name=""Submit3"" value=""选择图片..."">")
		...
		.echo "              <td width=""50%"" height=""24"">"
				If JSID = "" Or CStr(MoreLinkType) = "0" Then
					...
					.echo ("<input class='button' type=""button"" onClick=""OpenModalDialog('../SelectPic.asp?CurrPath=" & CurrPath & "&ShowVirtualPath=true',550,290,window,document.myform.MoreLinkPic);"" name=""Submit3"" value=""选择图片..."">")
		...
		.echo "                <input class='button' name=""SubmitPic"" class='button' onClick=""OpenModalDialog('../SelectPic.asp?CurrPath=" & CurrPath & "&ShowVirtualPath=true',550,290,window,document.myform.SplitPic);"" type=""button"" id=""SubmitPic2"" value=""选择图片..."">"
