...
Response.Write "<!DOCTYPE html><html><head><title>Bshare设置</title>" & vbCrLf
...
Response.Write "<div class=""tabTitle"">bShare分享插件</div>"
...
If Not KS.ReturnPowerResult(0, "KSO10002") Then
		Call KS.ReturnErr(1, "")
		exit sub
End If
...
<table border="0" align="center" cellpadding="3" cellspacing="1" width="100%" class="ctable">
<%if bshare_open="true" then%>
<tr class="tdbg">
	<td class="clefttitle" colspan="2" height="30" style="text-align:left"><strong>您已经开通bShare服务：</strong></td>
</tr>
<tr class="tdbg">
...
<tr class="tdbg">
	...
	<td width="80%"><input type="text" class="textbox" name="Bshare_Domain" size="35" value="<%=Bshare_Domain%>"> 
		<font color="red">* </font>
	</td>
</tr>
<tr class="tdbg">
...
<tr class="tdbg">
	...
	<td><input type="text" class="textbox" name="Bshare_UserName" size="35" value="<%=Bshare_UserName%>"> 
...
<tr class="tdbg">
	...
	<td><input type="password" class="textbox" name="Bshare_PassWord" size="35" value="<%=Bshare_PassWord%>"> 
		<font color="red">* </font>
	</td>
</tr>
...
<tr class="tdbg" id="rpass">
	...
	<td><input class="textbox" type="password" name="Bshare_RePassWord" size="35" value=""> 
		<font color="red">* </font>
	</td>
</tr>
...
<tr>
	<td style="text-align:left" colspan="2" class="attention"><b>说明</b><br/>&nbsp;&nbsp;bShare不止是一个分享按钮。bShare是全球中文互联网最强大的社交分享引擎！ 只需一个按钮，就能为您的网站注入社交化功能！<br/> 
...
<tr class="tdbg">
	<td class="clefttitle" colspan="2" height="30"  style="text-align:left"><strong>前台调用代码：</strong></td>
</tr>
<tr class="tdbg">
...
function getStyle(){
	top.openWin('选择Bshare分享插件样式','plus/plus_bshare/Bshare.asp?action=GetStyle',false,720,400);
}
</script>
<%
end if
...
Sub GetData()
	If Not KS.ReturnPowerResult(0, "KSO100021") Then
			Call KS.ReturnErr(1, "")
			exit sub
	End If
