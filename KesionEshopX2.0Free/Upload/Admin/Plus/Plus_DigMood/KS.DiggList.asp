...
%>	   		
     <SCRIPT language=javascript>
		...
		function show(t,m,d){ top.openWin('查看详情[<font color=red>'+t+'</font>]记录','plus/plus_digmood/KS.DiggList.asp?action=list&infoid='+d+'&ChannelID='+m,false); }
		function ShowCode(){   top.openWin('查看Digg调用代码','plus/plus_digmood/KS.DiggList.asp?action=ShowCode',false); }
	   ...
	   <%
		...
		.echo "<ul id='mt' class='quickLink'> <span id='mtl'>快速查看：</span><span>"
		.echo "<a href='javascript:ShowCode()'><i class='icon merge'></i>调用代码</a> | "
		...
		.echo "<div class='tabTitle'>文档DIG管理</div>"
		...
		Sub showContent()
		  ...
		  .echo " <td class='splittd' height='22'><i class='icon num'></i><span style='cursor:default;' title='" & RS("Title") & "'>"
					 ...
					 Else
								...
								If IsObject(XML) Then 
								  For Each Node In XML.DocumentElement.SelectNodes("row")
									 ...
									 .echo " <td height='22' class='splittd'><i class='icon num'></i><span style='cursor:default;'>"
