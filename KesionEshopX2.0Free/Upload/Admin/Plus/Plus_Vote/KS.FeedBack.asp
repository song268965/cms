...
Class FeedBack
	   ...
	   <%
		...
		.echo"<div class='tabTitle'>投诉建议管理</div>"
		...
		.echo"  </tr>"
		 ...
		 .echo("</td>")
		 .echo("<td><input type='submit' class='button' value=' 删 除 ' onclick='return(confirm(""确定删除选中的意见吗?""))'><br/><br/></td>")
		...
		Sub showContent(RS)
		 ...
		 Sub ShowDetail()
		  ...
		  <table cellspacing=0 cellpadding=0 width=100% align=center  border=0>
                    <tr>
                      <td class=title height=25 align="center"><font style="MARGIN-TOP: 2px; MARGIN-LEFT: 10px"><strong>会员意见</strong></font></td>
                    </tr>
          </table>
            <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
                  ...
                  <tr class="tdbg">
                    ...
                    <td height="25" class="tdbg">
					<%=rs("content")%>					</td>
                    <td height="25" align="right"  class="clefttitle">投 诉 人：</td>
		  ...
		  <table cellspacing=0 cellpadding=0 width=100% align=center  border=0>
                    <tr>
                      <td class=title height=25 align="center"><font style="MARGIN-TOP: 2px; MARGIN-LEFT: 10px"><strong>处理结果</strong></font></td>
                    </tr>
          </table>
            <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
			  ...
			  <input type="hidden" value="<%=id%>" name="id">
                  <tr class="tdbg">
                    ...
                    <td height="25" class="tdbg">
					<input type="text" name="accepttime" class="textbox" value="<%=accepttime%>" calss="textbox">
					</td>
                  </tr>
                  <tr class="tdbg">
