...
Class Admin_Field
		...
		.Write "<li class='parent' onclick='location.href=""Collect_ItemFilters.asp?ChannelID=" & ChannelID & """;'><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><i class='icon choose'></i>过滤设置</span></li>"
		.Write "<li class='parent' onclick='location.href=""Collect_IntoDatabase.asp?ChannelID=" & ChannelID & """;'><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><i class='icon audit'></i>审核入库</span></li>"
		.Write "<li class='parent' onclick='location.href=""Collect_ItemHistory.asp?ChannelID=" & ChannelID & """;'><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><i class='icon num'></i>历史记录</span></li>"
		.Write "<li class='parent' onclick='location.href=""Collect_Field.asp?ChannelID=" & ChannelID & """;'><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><i class='icon add'></i>自定义字段</span></li>"
		.Write "<li class='parent' onclick='location.href=""Collect_main.asp?ChannelID=" & ChannelID & """;'><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><i class='icon back'></i>回上一级</span></li>"
		.Write "</ul>"
        
		.Write "<div class='pageCont2'>"
		.Write "<div class='tabTitle'>采集自定义字段</div>"
		.Write "<div style='padding-bottom:15px;color:#626a70;'>请按模型设置要启用的自定义字段采集 &nbsp; <select id='channelid' name='channelid' onchange=""if (this.value!=0){location.href='?channelid='+this.value;}"">"
		...
		.Write "<table width='100%' border='0' cellpadding='0' cellspacing='0' class='mainTable'>"
		...
		.Write "        </tr>"
			...
			End If
		 .Write " <tr>"
		 .Write "   <td colspan='3' class='operatingBox'>&nbsp;&nbsp;<input type='submit' class='button' value='批量保存字段采集设置'> </td></form>"
		...
		Do While Not FieldRS.EOF
		 ...
		 '========================增加列表采集开关=================
		 .Write "   <td align='center' class='splittd'>" 
		 .Write "<label><input type='radio' value='1' name='ShowType"& FieldRS("FieldID")&"'"
		 If ShowType=1 Then .Write " Checked"
		 .Write ">列表页</label>"
		 .Write "<label><input type='radio' value='0' name='ShowType"& FieldRS("FieldID")&"'"
