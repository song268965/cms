		...
		Response.Write "      " & TitleStr & "结束标记：</td>"
		 ...
		 ElseIf KS.C_S(ChannelID,6)="5" Then '商城模型
				...
				Dim FieldNameList,FieldNameArr
				 ...
				 Response.Write "       <tr><td><font color=blue>商城价开始标记</font></td><td><textarea name=""Shop_PriceBeginStr"" cols=""49"" rows=""2"">" & Shop_PriceBeginStr & "</textarea></td><tr>"
				 Response.Write "       <tr><td><font color=blue>商城价结束标记</font></td><td><textarea name=""Shop_PriceEndStr"" cols=""49"" rows=""2"">" & Shop_PriceEndStr & "</textarea><br/><font color=red>Tips:当结束标记留空时,将读取开始标记作为默认值.</font></td></tr>"
