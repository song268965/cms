...
Class Collect_ItemModify5
		...
		Sub Kesion()
			...
			Response.Write "<div class='pageCont2'><table width=""100%"" border=""0"" align=""center"" cellpadding=""0"" cellspacing=""0"">"
			Response.Write "<tr align=""center"">"
			Response.Write "    <td colspan=""2"" valign=""bottom"">"
			Response.Write "    <font size=""3"">" & Title & "</font></td>"
			Response.Write "</tr>"
			Response.Write "  <tr align=""center"">"
			Response.Write "    <td colspan=""2"" class='pd10'>"
			Response.Write "        作者：" & Author & "&nbsp;&nbsp;来源：" & CopyFrom & "&nbsp;&nbsp;更新时间：" & UpDateTime
			Response.Write "    </td>"
			Response.Write "  </tr>"
			Response.Write "  <tr>"
			Response.Write "    <td colspan=""2"" align=""center"" valign=""top"">"
			Response.Write "      <div style=""width:95%"">"
			Response.Write "      <table width=""95%"" height=""100%"" border=""0"" align=""center"" cellpadding=""0"" cellspacing=""0"">"
			 Response.Write "       <tr>"
			 Response.Write "         <td height=""200"" valign=""top"" align=""left""><p>" & Content & "</p>"
			 Response.Write "         </td>"
			 Response.Write "       </tr>"
			 Response.Write "     </table>"
			 Response.Write "     </div>"
			 Response.Write "     <div align=""center"" style=""height:30;line-height:30px;""><b>关键字：" & Key & "</b></div>"
			 Response.Write "   </td>"
			 Response.Write " </tr>"
