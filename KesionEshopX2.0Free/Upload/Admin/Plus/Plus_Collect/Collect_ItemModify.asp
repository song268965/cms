...
Class Collect_ItemModify
		...
		Else
		   ItemID = CLng(ItemID)
		   SqlItem = "select top 1 ItemID,ItemName,CharsetCode,WebName,WebUrl,ChannelID,ClassID,SpecialID,LoginType,LoginUrl,LoginPostUrl,LoginUser,LoginPass,LoginFalse,ItemDemo From KS_CollectItem where ItemID=" & ItemID
		...
		With KS
		  ...
		  .echo "    <tr class='tdbg'>"
		   ...
		   .echo "     <td width=""796"">"
		   .echo "     <input name=""ItemName"" type=""text"" size=""27"" class=""textbox"" style='margin-left:0' maxlength=""30"" value=""" & ItemName & """>&nbsp;&nbsp;<font color=red>*</font>如：新浪网－新闻中心</td>"
		    .echo "  </tr>"
		    .echo "  <tr class='tdbg'>"
		  ...
		  .echo "      <td width=""796"">"
		  .echo "<select name='SpecialID' id='SpecialID' multiple style='height:100px;width:380px;margin-left:0' class='textbox'>" &KS.ReturnSpecial(KS.FilterIds(SpecialID)) & "</select>"
		  .echo "    <br/> <span class='tips'>提示：需要选择直接入库才有效。</span> </td> "
		   .echo "   </tr>"
		   ...
		   .echo "     <td width=""796"">"
		    .echo "      <input name=""WebName"" type=""text"" class=""textbox"" size=""27"" maxlength=""30"" style='margin-left:0;' value=""" & WebName & """>      </td>"
		    .echo "  </tr>"
		     .echo "   <tr  class='tdbg' class='tdbg'>"
		 ...
		 if CharsetCode="gb2312" then   .echo("selected")
		  ...
		  If LoginType = 0 Then   .echo " style=""display:none"" "
		   ...
		   .echo "     <td>"
		   .echo "       登录地址：<input name=""LoginUrl""  class=""textbox"" type=""text"" size=""40"" maxlength=""150"" value=""" & LoginUrl & """><br><br>"
		   .echo "       提交地址：<input name=""LoginPostUrl""  class=""textbox"" type=""text"" size=""40"" maxlength=""150"" value=""" & LoginPostUrl & """><br><br>"
		   .echo "       用户参数：<input name=""LoginUser""  class=""textbox"" type=""text"" size=""30"" maxlength=""150"" value=""" & LoginUser & """><br><br>"
		   .echo "       密码参数：<input name=""LoginPass""  class=""textbox"" type=""text"" size=""30"" maxlength=""150"" value=""" & LoginPass & """><br><br>"
