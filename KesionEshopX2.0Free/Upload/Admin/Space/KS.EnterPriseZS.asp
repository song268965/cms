...
{ 
 top.openWin("查看企业荣誉证书","space/KS.EnterpriseZS.asp?action=View&ProID="+id,false)
}
</script>
<div class="pageCont2">
...
<%
	...
	If Rs.bof And Rs.EOF Then
		Response.Write "<tr><td height=""25"" align=center bgcolor=""#ffffff"" colspan=10 class='splittd'>没有用户上传企业荣誉证书！</td></tr>"
	Else
