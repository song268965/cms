...
<script>
 function play(s,t){
	   top.openWin("歌曲试听","KS.SpaceMusic.asp?action=play&songname="+t+"&url="+s+"&rnd="+Math.random(),false,550,150)
  }
</script>
<div class="pageCont2">
...
<%
	...
	If Rs.bof And Rs.EOF Then
		Response.Write "<tr class='list'><td height=""65"" align=center colspan=7>没有人发表歌曲！</td></tr>"
	Else
