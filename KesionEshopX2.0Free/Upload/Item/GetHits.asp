...
If Action="commentnum" Then  '评论数
  ...
  If Not RS.Eof Then
   ...
   Else
  KS.Die "document.write('<a href=""" & KS.GetDomain & "plus/digmood/Comment.asp?ChannelID=" & channelid & "&InfoID=" & id & """ target=""_blank"">我要评论(<span>" & conn.execute("select top 1 cmtnum from " & KS.C_S(ChannelID,2) &" where id=" & id)(0) & "</span>)</a>');"
   End If
 End If
 KS.Die ""
End If
